...
if __name__== "__main__":
    ...
    export_all_contours(train_ctrs, TRAIN_IMG_PATH, "data/sunnybrook_training/train_images227_lmdb", "data/sunnybrook_training/train_labels227_lmdb")
    print("\nBuilding LMDB for val...")
    export_all_contours(val_ctrs, TRAIN_IMG_PATH, "data/sunnybrook_training/val_images227_lmdb", "data/sunnybrook_training/val_labels227_lmdb")
